...
UserValidation.UPDATE = zod_1.z.object({
    name: zod_1.z.string().min(1).max(100).optional(), // optional mean it's not required
    password: zod_1.z.string().min(1).max(100).optional(), // optional mean it's not required
});
