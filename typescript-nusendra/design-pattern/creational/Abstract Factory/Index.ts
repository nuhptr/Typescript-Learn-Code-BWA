namespace AbstractFactory {
   ...
   class ComputerFactory {
      static buildComputer(monitorType: MonitorType, computerType: ComputerType): Computer {
         switch (monitorType) {
   ...
   const laptopLed = ComputerFactory.buildComputer(MonitorType.LED, ComputerType.LAPTOP)
